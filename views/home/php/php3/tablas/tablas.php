...
<body style="background-image: url(assets/img/ser.jpeg); background-repeat:no-repeat; 
background-size: 100%; background-attachment: fixed; text-align: center;">

<h1 align="center" style="margin-top: 15px; background-image:url(img/2.jpg); border-radius: 15px; text-shadow:
-1px -1px 0 #fff,  
1px -1px 0 #fff,
-1px 1px 0 #fff,
1px 1px 0 #fff; color: #FF69B4;">Tablas de multiplicar de Luna :)
</h1>
<br>
<audio style="" src="audio/1.mp3" preload="none" controls></audio>
<hr>
<audio id="demo" src="audio/Luna.mp3"></audio>
<div>
...
<br>
<!-- shift + f5 -->
<!-- sabe que huese pidido hacer todo solo con js p -->
<div id="main-container">
  <table border="9" width="60%" align="center" style="font-size: 25px;
  font-weight: bold; color: blue; text-align: center; text-shadow:
  -1px -1px 0 #fff,  
  1px -1px 0 #fff,
  -1px 1px 0 #fff,
  1px 1px 0 #fff; border: 9px outset lightgreen; background-color: lightblue; opacity: 0.9; border-radius: 14px; margin-bottom: 30px;">


  <thead>
   <tr>
    <th>---</th><th style="color:red;">Aprende</th><th>---</th>
  </tr>
</thead>
...
<tr>
 ...
 <td style="color:#8B4513"><?php include('bucle_for.php'); tabla2(); ?></td>
 <td style="color:#6495ED"><?php tabla3(); ?></td>
 <td style="color:#8B008B"><?php tabla4(); ?></td>

</tr>	

<tr>

 <td style="color:#228B22"><?php tabla5(); ?></td>
 <td style="color:#CD5C5C"><?php tabla6(); ?></td>
 <td style="color:#4B0082"><?php tabla7(); ?></td>

</tr>	

<tr>

 <td style="color:#FF4500"><?php tabla8(); ?></td>
 <td style="color:#FFA500"><?php tabla9(); ?></td>
 <td style="color:#9ACD32"><?php tabla10(); ?></td>
