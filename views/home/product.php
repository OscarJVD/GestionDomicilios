...
<head>
 ...
 '><!--Esto es para ayudar a los padres y a las escuelas a controlar los lugares a los
  ...
  <!--TERMINA AQUI --------------------------------------------------------------META-->
  <!----------------------------------------------------------------------------------->
  <title>Productos | Solumobil</title>
	...
	<div class="page-container">
		<nav class="full-reset nav-phonestore">
			...
			<ul class="list-unstyled full-reset navigation-list">
              <li class="liLineas"><a href="index.php" class="fa fa-home"></a></li><!-- index.php-->
              <li><a href="" onclick="alert('PROXIMAMENTE');">PRODUCTOS</a></li>  <!-- product.php-->
              <li><a href="news.php">NOSOTROS</a></li><!-- news.php-->
              <li><a href="services.php">SERVICIOS</a></li> <!--services.php-->

              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="../PHP_Parte_1/PHP_Parte_1.php">PHP</a>
          ...
          <li class="liLineas"><a href="contact.php" class="fa fa-phone"></a></li><!-- contact.php-->
                <li><a href="../Login_and_Signin/inicioSesion.php" class="acceder">Acceder</a></li><!-- contact.php-->
                <li><a href="../Login_and_Signin/inicioSesion.php" class="crearCuenta">Crear cuenta</a></li><!-- contact.php-->
            </ul>
