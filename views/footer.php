<div class="w-100 mb-5">
    <div class="flex-md-row-reverse w-100">
        <footer class="page-footer font-small py-2 foot w-100" id="foot">
            ...
            <div class="container-fluid w-100">
                <div class="row">
                    <div class="col-12 col-sm-12 text-center">
                        <h3 class="h5 text-light">Siguenos en</h3>
                        <ul class="list-unstyled list-social-icons text-center row justify-content-center">
                            ...
                            <li class="d-block col-sm-1 col-md-1">
                                <a href="https://api.whatsapp.com/send?phone=573133043714&text=%C2%A1Hola!%20Quisiera%20saber%20mas%20acerca%20de%20los%20servicios%20y%20productos%20tecnologicos%20que%20ofrece">
                        ...
                        <h4 class="h6 text-light"> &copy; 2020 Solumobil Todos los derechos reservados.</h4>
                        <p class="politica">
                            <a href="views/home/login/politicaPrivacidad.php">Política de protección de datos personales y privacidad</a>
                        </p>
                    </div>
                </div>
            </div>
